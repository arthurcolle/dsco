# 2197 — Flaky test diagnostician: Learned semantic batch control

Implement the learned semantic batch control feature for the Flaky test diagnostician RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Distinguish nondeterministic product defects from unreliable test infrastructure before proposing code changes or quarantining tests.
