# 1777 — Protocol state inferencer: Learned semantic batch control

Implement the learned semantic batch control feature for the Protocol state inferencer RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Train a protocol RLM to infer hidden interaction states through bounded probes and distinguishing response sequences.
