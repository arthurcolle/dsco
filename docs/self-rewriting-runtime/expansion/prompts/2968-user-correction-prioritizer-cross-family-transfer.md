# 2968 — User correction prioritizer: Measured cross-family transfer

Implement the measured cross-family transfer feature for the User correction prioritizer RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Convert user corrections into precise objective changes while retaining authorized work that the correction does not supersede.
