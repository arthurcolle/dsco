# 2368 — Session recovery strategist: Measured cross-family transfer

Implement the measured cross-family transfer feature for the Session recovery strategist RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Reconstruct the next valid action after interruption without replaying effects whose outcomes are already committed or uncertain.
