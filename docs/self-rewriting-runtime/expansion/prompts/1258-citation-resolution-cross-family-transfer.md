# 1258 — Citation resolver: Measured cross-family transfer

Implement the measured cross-family transfer feature for the Citation resolver RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Train a citation RLM to resolve each technical assertion to an actual retrievable supporting passage.
