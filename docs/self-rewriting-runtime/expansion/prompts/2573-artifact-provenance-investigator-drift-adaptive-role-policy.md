# 2573 — Artifact provenance investigator: Drift-adaptive role policy

Implement the drift-adaptive role policy feature for the Artifact provenance investigator RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Explain which exact source, dataset, model, and execution produced an artifact without treating labels as proof.
