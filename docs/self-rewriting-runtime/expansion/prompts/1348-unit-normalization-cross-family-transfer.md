# 1348 — Unit and scale normalizer: Measured cross-family transfer

Implement the measured cross-family transfer feature for the Unit and scale normalizer RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Train a unit RLM to normalize quantitative observations without losing dimensions, scales, or measurement conventions.
