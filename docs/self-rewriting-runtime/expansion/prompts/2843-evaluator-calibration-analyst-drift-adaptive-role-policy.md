# 2843 — Evaluator calibration analyst: Drift-adaptive role policy

Implement the drift-adaptive role policy feature for the Evaluator calibration analyst RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Measure whether a role evaluator's confidence and labels predict independently verified outcomes instead of reinforcing self-assessment.
