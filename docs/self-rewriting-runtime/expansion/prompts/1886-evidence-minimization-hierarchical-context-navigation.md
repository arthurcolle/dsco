# 1886 — Evidence set minimizer: Hierarchical context navigation

Implement the hierarchical context navigation feature for the Evidence set minimizer RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Train an evidence RLM to find small sufficient support sets without deleting decisive counterexamples or required conditions.
