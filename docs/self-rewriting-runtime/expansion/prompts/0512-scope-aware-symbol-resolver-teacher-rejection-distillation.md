# 512 — Scope-aware native symbol resolver: Teacher rejection distillation

Implement the teacher rejection distillation feature for the Scope-aware native symbol resolver RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Learn native symbol resolution procedures that preserve scope, visibility, overload contracts, and generation-specific definitions.
