# 2703 — Model drift diagnostician: Faithful root-turn supervision

Implement the faithful root-turn supervision feature for the Model drift diagnostician RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Distinguish learned-policy regression from workload drift, serving substitution, and changes in the evaluation instrument.
