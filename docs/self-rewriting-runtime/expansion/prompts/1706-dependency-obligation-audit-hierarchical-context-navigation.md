# 1706 — Dependency obligation auditor: Hierarchical context navigation

Implement the hierarchical context navigation feature for the Dependency obligation auditor RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Train an obligation RLM to verify that prerequisite completion actually supplies the evidence needed by dependent work.
