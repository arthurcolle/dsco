# 2802 — Rollout staleness manager: Verified long-output assembly

Implement the verified long-output assembly feature for the Rollout staleness manager RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Admit asynchronous training rollouts only when their behavior-policy versions and statistical assumptions remain valid.
