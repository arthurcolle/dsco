# 2488 — Spend reservation reconciler: Measured cross-family transfer

Implement the measured cross-family transfer feature for the Spend reservation reconciler RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Reconcile estimated, reserved, settled, and uncertain spend so concurrent role calls cannot reuse the same remaining budget.
