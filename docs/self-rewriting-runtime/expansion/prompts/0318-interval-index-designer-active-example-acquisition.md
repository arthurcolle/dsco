# 318 — Revision-scoped interval index designer: Active example acquisition

Implement the active example acquisition feature for the Revision-scoped interval index designer RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Learn interval index procedures for source spans that answer overlap and containment queries accurately after revision changes.
