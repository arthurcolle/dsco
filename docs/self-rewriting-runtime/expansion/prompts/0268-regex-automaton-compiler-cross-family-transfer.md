# 268 — Bounded regex automaton compiler: Measured cross-family transfer

Implement the measured cross-family transfer feature for the Bounded regex automaton compiler RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Learn native matcher generation for a declared regular-expression subset using bounded automata instead of uncontrolled backtracking.
