# 2792 — Rollout staleness manager: Teacher rejection distillation

Implement the teacher rejection distillation feature for the Rollout staleness manager RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Admit asynchronous training rollouts only when their behavior-policy versions and statistical assumptions remain valid.
