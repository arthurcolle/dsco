# 1782 — Protocol state inferencer: Verified long-output assembly

Implement the verified long-output assembly feature for the Protocol state inferencer RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Train a protocol RLM to infer hidden interaction states through bounded probes and distinguishing response sequences.
