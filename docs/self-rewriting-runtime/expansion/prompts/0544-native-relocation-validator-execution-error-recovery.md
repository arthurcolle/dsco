# 544 — Native relocation validator: Learned execution-error recovery

Implement the learned execution-error recovery feature for the Native relocation validator RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Learn relocation decoding and validation procedures for an explicit native object-format subset before executable admission.
