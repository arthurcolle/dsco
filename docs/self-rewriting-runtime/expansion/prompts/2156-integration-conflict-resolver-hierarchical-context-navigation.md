# 2156 — Integration conflict resolver: Hierarchical context navigation

Implement the hierarchical context navigation feature for the Integration conflict resolver RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Propose conflict resolutions that preserve independently established behavior from concurrent agents rather than accepting whichever patch applies.
