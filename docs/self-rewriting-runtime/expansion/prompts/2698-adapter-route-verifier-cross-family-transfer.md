# 2698 — Adapter route verifier: Measured cross-family transfer

Implement the measured cross-family transfer feature for the Adapter route verifier RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Ensure each role and recursive tree receives its intended immutable adapter rather than a similarly named model.
