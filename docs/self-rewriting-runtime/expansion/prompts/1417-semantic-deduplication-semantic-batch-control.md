# 1417 — Semantic occurrence deduplicator: Learned semantic batch control

Implement the learned semantic batch control feature for the Semantic occurrence deduplicator RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Train an evidence RLM to deduplicate repeated observations without merging genuinely distinct or contradictory occurrences.
