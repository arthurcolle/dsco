# 2364 — Session recovery strategist: Dependency-scoped retraining

Implement the dependency-scoped retraining feature for the Session recovery strategist RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Reconstruct the next valid action after interruption without replaying effects whose outcomes are already committed or uncertain.
