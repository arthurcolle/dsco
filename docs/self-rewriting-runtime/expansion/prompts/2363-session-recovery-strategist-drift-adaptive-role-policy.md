# 2363 — Session recovery strategist: Drift-adaptive role policy

Implement the drift-adaptive role policy feature for the Session recovery strategist RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Reconstruct the next valid action after interruption without replaying effects whose outcomes are already committed or uncertain.
