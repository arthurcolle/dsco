# 2273 — Tool argument repairer: Drift-adaptive role policy

Implement the drift-adaptive role policy feature for the Tool argument repairer RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Repair malformed tool arguments while preserving the user's requested operation and the existing capability boundary.
