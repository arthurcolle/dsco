# 448 — Logical snapshot codec designer: Measured cross-family transfer

Implement the measured cross-family transfer feature for the Logical snapshot codec designer RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Learn compact native codecs for immutable logical snapshots while preserving shared references, cycles, and schema identities.
