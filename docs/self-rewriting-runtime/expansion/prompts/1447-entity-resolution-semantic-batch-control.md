# 1447 — Entity identity resolver: Learned semantic batch control

Implement the learned semantic batch control feature for the Entity identity resolver RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Train an entity RLM to resolve identities across traces and documents without collapsing similar names.
