# 1927 — Discriminating experiment designer: Learned semantic batch control

Implement the learned semantic batch control feature for the Discriminating experiment designer RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Train an experiment RLM to choose permitted probes that distinguish current hypotheses under realistic costs and controls.
