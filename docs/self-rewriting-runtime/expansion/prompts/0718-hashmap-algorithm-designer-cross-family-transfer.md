# 718 — Native hashmap collision policy designer: Measured cross-family transfer

Implement the measured cross-family transfer feature for the Native hashmap collision policy designer RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Learn native hashmap lookup, insertion, deletion, and resizing procedures that preserve key identity under adversarial collisions.
