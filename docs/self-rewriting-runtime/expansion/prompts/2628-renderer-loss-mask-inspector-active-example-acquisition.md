# 2628 — Renderer loss-mask inspector: Active example acquisition

Implement the active example acquisition feature for the Renderer loss-mask inspector RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Check whether role-root SFT trains exactly the intended generated tokens under the selected model renderer.
