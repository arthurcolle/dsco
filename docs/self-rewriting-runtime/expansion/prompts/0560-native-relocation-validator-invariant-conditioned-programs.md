# 560 — Native relocation validator: Invariant-conditioned program generation

Implement the invariant-conditioned program generation feature for the Native relocation validator RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Learn relocation decoding and validation procedures for an explicit native object-format subset before executable admission.
