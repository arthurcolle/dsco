# 1457 — Entity identity resolver: Learned typed role handoffs

Implement the learned typed role handoffs feature for the Entity identity resolver RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Train an entity RLM to resolve identities across traces and documents without collapsing similar names.
