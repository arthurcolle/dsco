# 2347 — Session recovery strategist: Learned semantic batch control

Implement the learned semantic batch control feature for the Session recovery strategist RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Reconstruct the next valid action after interruption without replaying effects whose outcomes are already committed or uncertain.
