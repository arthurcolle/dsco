# 528 — Scope-aware native symbol resolver: Active example acquisition

Implement the active example acquisition feature for the Scope-aware native symbol resolver RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Learn native symbol resolution procedures that preserve scope, visibility, overload contracts, and generation-specific definitions.
