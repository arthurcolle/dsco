# 2813 — Rollout staleness manager: Drift-adaptive role policy

Implement the drift-adaptive role policy feature for the Rollout staleness manager RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Admit asynchronous training rollouts only when their behavior-policy versions and statistical assumptions remain valid.
