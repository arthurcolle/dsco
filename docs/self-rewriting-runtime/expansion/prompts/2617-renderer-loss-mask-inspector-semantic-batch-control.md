# 2617 — Renderer loss-mask inspector: Learned semantic batch control

Implement the learned semantic batch control feature for the Renderer loss-mask inspector RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Check whether role-root SFT trains exactly the intended generated tokens under the selected model renderer.
