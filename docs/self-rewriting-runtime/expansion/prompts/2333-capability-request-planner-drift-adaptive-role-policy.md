# 2333 — Capability request planner: Drift-adaptive role policy

Implement the drift-adaptive role policy feature for the Capability request planner RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Find a least-authority execution plan that satisfies the objective or explains the precise missing permission.
