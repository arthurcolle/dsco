# 1463 — Entity identity resolver: Drift-adaptive role policy

Implement the drift-adaptive role policy feature for the Entity identity resolver RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Train an entity RLM to resolve identities across traces and documents without collapsing similar names.
