# 1867 — Evidence set minimizer: Learned semantic batch control

Implement the learned semantic batch control feature for the Evidence set minimizer RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Train an evidence RLM to find small sufficient support sets without deleting decisive counterexamples or required conditions.
