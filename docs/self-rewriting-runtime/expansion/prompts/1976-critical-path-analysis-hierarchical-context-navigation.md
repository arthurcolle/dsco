# 1976 — Critical-path evidence analyst: Hierarchical context navigation

Implement the hierarchical context navigation feature for the Critical-path evidence analyst RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Train a critical-path RLM to identify which dependency delays actually constrain end-to-end completion rather than summing durations.
