# 2398 — Runaway recursion triager: Measured cross-family transfer

Implement the measured cross-family transfer feature for the Runaway recursion triager RLM in `/Users/arthurcolle/Dsco/dsco-cli` or its assigned worktree. Locate recursive branches that consume resources without advancing the task and stop only work proven redundant or invalid.
