...
static inline const char *node_role_label(node_role_t r) {
    static const char *labels[] = {
        "coordinator", "delegator", "worker",    "classifier", "critic", "synthesizer",
        "specialist",  "generator", "validator", "reducer",    "scout",  "judge",
    };
...
static inline const char *topo_category_label(topo_category_t c) {
    static const char *labels[] = {
        "chain", "fanout", "hierarchy", "mesh", "specialist", "feedback", "competitive", "domain",
    };
