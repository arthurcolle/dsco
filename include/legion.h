...
static inline const char *legion_role_name(legion_role_t r) {
    static const char *names[] = {
        "executor",   "planner",         "plan_checker", "verifier",   "debugger",
        "researcher", "codebase_mapper", "synthesizer",  "roadmapper", "integration_checker",
        "auditor",    "ui_researcher",   "ui_checker",   "profiler",   "reducer",
        "scout",
    };
...
static inline node_role_t legion_to_node_role(legion_role_t r) {
    switch (r) {
        case LEGION_ROLE_EXECUTOR:
            return ROLE_WORKER;
        case LEGION_ROLE_PLANNER:
            return ROLE_COORDINATOR;
        case LEGION_ROLE_PLAN_CHECKER:
            return ROLE_VALIDATOR;
        case LEGION_ROLE_VERIFIER:
            return ROLE_VALIDATOR;
        case LEGION_ROLE_DEBUGGER:
            return ROLE_SPECIALIST;
        case LEGION_ROLE_RESEARCHER:
            return ROLE_SCOUT;
        case LEGION_ROLE_CODEBASE_MAPPER:
            return ROLE_SCOUT;
        case LEGION_ROLE_SYNTHESIZER:
            return ROLE_SYNTHESIZER;
        case LEGION_ROLE_ROADMAPPER:
            return ROLE_DELEGATOR;
        case LEGION_ROLE_INTEGRATION_CHK:
            return ROLE_VALIDATOR;
        case LEGION_ROLE_AUDITOR:
            return ROLE_CRITIC;
        case LEGION_ROLE_UI_RESEARCHER:
            return ROLE_SCOUT;
        case LEGION_ROLE_UI_CHECKER:
            return ROLE_CRITIC;
        case LEGION_ROLE_PROFILER:
            return ROLE_CLASSIFIER;
        case LEGION_ROLE_REDUCER:
            return ROLE_REDUCER;
        case LEGION_ROLE_SCOUT:
            return ROLE_SCOUT;
        default:
            return ROLE_WORKER;
    }
