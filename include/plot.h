...
int plot_candlestick(char *out, size_t cap, const double *open, const double *high,
                     const double *low, const double *close, int n, const plot_opts_t *o);
...
int plot_waterfall(char *out, size_t cap, const char *const *labels, const double *deltas, int n,
                   const plot_opts_t *o);
...
int plot_bullet(char *out, size_t cap, const char *label, double value, double target,
                const double *ranges, int nr, const plot_opts_t *o);
...
int plot_slope(char *out, size_t cap, const char *const *labels, const double *left,
               const double *right, int n, const plot_opts_t *o);
...
int plot_ridgeline(char *out, size_t cap, const char *const *names, const double *const *series,
                   const int *lens, int n_series, const plot_opts_t *o);
...
int plot_attractor(char *out, size_t cap, const char *kind, double a, double b, double c, double d,
                   long iters, const plot_opts_t *o);
