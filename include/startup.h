...
#define DSCO_CAP_FULL                                                                              \
    (DSCO_CAP_SECURITY | DSCO_CAP_PROVIDER | DSCO_CAP_TOOLS | DSCO_CAP_TUI | DSCO_CAP_VOS |        \
     DSCO_CAP_IPC | DSCO_CAP_MCP | DSCO_CAP_MEMORY | DSCO_CAP_ACCEL | DSCO_CAP_TRUST |             \
     DSCO_CAP_TRACE)
