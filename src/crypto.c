...
static const int MD5_S[64] = {7, 12, 17, 22, 7, 12, 17, 22, 7, 12, 17, 22, 7, 12, 17, 22,
...
static size_t b64_encode_internal(const uint8_t *src, size_t src_len, char *dst, size_t dst_len,
...
static size_t b64_decode_internal(const char *src, size_t src_len, uint8_t *dst, size_t dst_len) {
    size_t out = 0;
    uint32_t buf = 0;
    int bits = 0;
