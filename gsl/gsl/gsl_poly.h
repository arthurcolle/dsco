...
int gsl_poly_dd_taylor(double c[], double xp, const double dd[], const double xa[], size_t size,
                       double *w);
...
int gsl_poly_complex_solve_quadratic(double a, double b, double c, gsl_complex *z0,
                                     gsl_complex *z1);

int gsl_poly_solve_cubic(double a, double b, double c, double *x0, double *x1, double *x2);
int gsl_poly_complex_solve_cubic(double a, double b, double c, gsl_complex *z0, gsl_complex *z1,
                                 gsl_complex *z2);
