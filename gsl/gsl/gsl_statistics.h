...
double gsl_stats_variance_with_fixed_mean(const double data[], size_t stride, size_t n,
                                          double mean);
...
double gsl_stats_correlation(const double data1[], size_t stride1, const double data2[],
                             size_t stride2, size_t n);
double gsl_stats_spearman(const double data1[], size_t stride1, const double data2[],
                          size_t stride2, size_t n, double work[]);
...
double gsl_stats_trmean_from_sorted_data(double trim, const double sorted_data[], size_t stride,
                                         size_t n);
...
double gsl_stats_sn_from_sorted_data(const double sorted_data[], size_t stride, size_t n,
                                     double work[]);
double gsl_stats_qn_from_sorted_data(const double sorted_data[], size_t stride, size_t n,
