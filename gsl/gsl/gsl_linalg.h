...
int gsl_linalg_LU_refine(const gsl_matrix *A, const gsl_matrix *LU, const gsl_permutation *p,
...
int gsl_linalg_QR_QRsolve(gsl_matrix *Q, gsl_matrix *R, const gsl_vector *b, gsl_vector *x);
int gsl_linalg_QR_UR_solve(const gsl_matrix *S, const gsl_matrix *A, const gsl_vector *b,
                           gsl_vector *x);
...
int gsl_linalg_QRPT_update(gsl_matrix *Q, gsl_matrix *R, const gsl_permutation *p, gsl_vector *w,
                           const gsl_vector *v);
int gsl_linalg_QR_UR_lssolve(const gsl_matrix *S, const gsl_matrix *A, const gsl_vector *b,
                             gsl_vector *x, gsl_vector *work);
int gsl_linalg_QR_UR_lssvx(const gsl_matrix *S, const gsl_matrix *A, gsl_vector *x,
                           gsl_vector *work);
...
int gsl_linalg_cholesky_solve2(const gsl_matrix *L, const gsl_vector *S, const gsl_vector *b,
                               gsl_vector *x);
...
int gsl_linalg_pcholesky_invert(const gsl_matrix *pchol, const gsl_permutation *p,
                                gsl_matrix *inverse);
int gsl_linalg_pcholesky_rcond(const gsl_matrix *pchol, const gsl_permutation *p, double *rcond,
                               gsl_vector *work);
...
int gsl_linalg_mcholesky_rcond(const gsl_matrix *mchol, const gsl_permutation *p, double *rcond,
                               gsl_vector *work);
int gsl_linalg_mcholesky_invert(const gsl_matrix *mchol, const gsl_permutation *p,
                                gsl_matrix *inverse);
...
int gsl_linalg_complex_cholesky_rcond(const gsl_matrix_complex *L, double *rcond,
                                      gsl_vector_complex *work);

int gsl_linalg_hesstri_decomp(gsl_matrix *A, gsl_matrix *B, gsl_matrix *U, gsl_matrix *V,
                              gsl_vector *work);
int gsl_linalg_hesstri_decomp1(gsl_matrix *A, gsl_matrix *B, gsl_matrix *U, gsl_matrix *V,
                               gsl_vector *work);
